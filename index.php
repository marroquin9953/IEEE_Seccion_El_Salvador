...
<head>
    ...
    <title>AnderCode - Preguntas y Respuestas Sociales</title>
</head>
<body>
            ...
            <div class="col-lg-2">
                <div class="logo-box">
                    <a href="index" class="logo">
                        <img src="https://brand-experience.ieee.org/wp-content/themes/porto-child/img/ieee-logo.png" alt="logo" width="150" height="auto">
                    </a>
        ...
        <div class="row">
            <div class="col-lg-6 mr-auto">
                <div class="hero-content">
                    <h2 class="section-title fs-50 pb-3 text-white lh-65">¡Únete a la comunidad más grande del mundo!</h2>
                    <p class="lh-26 text-white">Explora un universo de conocimiento y conecta con personas.</p>
                    <div class="hero-btn-box pt-30px">
                        <a href="question" class="btn theme-btn me-2">Ver todos los eventos </a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <a href="home-2.html" class="btn theme-btn">Browse questions <i class="la la-arrow-right icon ms-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        <svg width="70" viewbox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"><path d="m18.393 38.405c-.055-.674-.09-1.353-.09-2.041a24.887 24.887 0 0 1 43.171-16.888 22.577 22.577 0 0 1 30.826 6.882 18.466 18.466 0 0 1 25.4 23.657 18.459 18.459 0 0 1 -18.184 32.132 18.453 18.453 0 0 1 -25.566 3.314 19.9 19.9 0 0 1 -35.15-2.028 24.895 24.895 0 1 1 -20.4-45.028z" fill="#f0f5f9"></path><path d="m1 62.146a24.91 24.91 0 0 0 37.8 21.291 19.892 19.892 0 0 0 35.15 2.02 18.442 18.442 0 0 0 25.565-3.31 18.467 18.467 0 0 0 26.975-20.417 18.461 18.461 0 0 1 -26.976 11.808 18.445 18.445 0 0 1 -25.565 3.31 19.882 19.882 0 0 1 -17.049 9.625c-8.041 0-11.776-2.155-11.509-9.358-3.765 2.285-13.42 4.268-18.141 4.268-12.285 0-23.844-11.866-25.874-23.562a25.252 25.252 0 0 0 -.376 4.325z" fill="#d9e2e9"></path><g fill="#2f3a5a"><path d="m56.906 96.09a20.952 20.952 0 0 1 -18.536-11.255 25.9 25.9 0 1 1 -21.028-47.135c-.027-.467-.039-.909-.039-1.336a25.887 25.887 0 0 1 44.344-18.156 23.577 23.577 0 0 1 30.992 6.874 19.222 19.222 0 0 1 8.061-1.749 19.47 19.47 0 0 1 18.238 26.267 19.459 19.459 0 0 1 -19.172 33.814 19.456 19.456 0 0 1 -25.539 3.471 20.733 20.733 0 0 1 -17.321 9.205zm-18.106-13.657a1 1 0 0 1 .91.585 18.9 18.9 0 0 0 33.386 1.926 1 1 0 0 1 1.457-.282 17.453 17.453 0 0 0 24.18-3.135 1 1 0 0 1 1.274-.252 17.46 17.46 0 0 0 17.193-30.393 1 1 0 0 1 -.423-1.259 17.461 17.461 0 0 0 -24.024-22.374 1 1 0 0 1 -1.294-.345 21.575 21.575 0 0 0 -29.459-6.578 1 1 0 0 1 -1.262-.171 23.887 23.887 0 0 0 -41.438 16.209c0 .6.028 1.244.087 1.959a1 1 0 0 1 -.7 1.035 23.894 23.894 0 1 0 19.585 43.22 1 1 0 0 1 .528-.145z"></path><path d="m25.9 88.034a25.921 25.921 0 0 1 -25.9-25.891 1 1 0 0 1 2 0 23.895 23.895 0 0 0 44.876 11.43 1 1 0 0 1 1.756.958 25.9 25.9 0 0 1 -22.732 13.503z"></path><path d="m95.953 39.672a1 1 0 0 1 -1-1 21.584 21.584 0 0 0 -39.182-12.5 1 1 0 0 1 -1.63-1.159 23.584 23.584 0 0 1 42.812 13.659 1 1 0 0 1 -1 1z"></path><path d="m113.436 57.16a1 1 0 0 1 -.69-1.724 17.461 17.461 0 0 0 -12.046-30.1 1 1 0 0 1 0-2 19.46 19.46 0 0 1 13.425 33.55.992.992 0 0 1 -.689.274z"></path></g><path d="m64 39.039a20.832 20.832 0 0 0 -20.832 20.832v19.3h5.9v-19.3a14.93 14.93 0 1 1 29.859 0v19.3h5.9v-19.3a20.832 20.832 0 0 0 -20.827-20.832z" fill="#84879c"></path><path d="m84.831 80.172h-5.9a1 1 0 0 1 -1-1v-19.3a13.93 13.93 0 1 0 -27.859 0v19.3a1 1 0 0 1 -1 1h-5.9a1 1 0 0 1 -1-1v-19.3a21.832 21.832 0 1 1 43.663 0v19.3a1 1 0 0 1 -1.004 1zm-4.9-2h3.9v-18.3a19.832 19.832 0 1 0 -39.663 0v18.3h3.9v-18.3a15.93 15.93 0 1 1 31.859 0z" fill="#2f3a5a"></path><rect fill="#fac77c" height="43.593" rx="8.123" width="53.599" x="37.2" y="72.934"></rect><path d="m90.8 81.053v27.354a8.126 8.126 0 0 1 -8.13 8.119h-37.348a8.091 8.091 0 0 1 -6.61-3.408 7.862 7.862 0 0 0 2.576.421h37.352a8.135 8.135 0 0 0 8.13-8.129v-27.344a8.166 8.166 0 0 0 -1.509-4.722 8.154 8.154 0 0 1 5.539 7.709z" fill="#e5ae5c"></path><path d="m82.676 117.527h-37.353a9.133 9.133 0 0 1 -9.123-9.127v-27.342a9.133 9.133 0 0 1 9.123-9.123h37.353a9.133 9.133 0 0 1 9.124 9.123v27.342a9.133 9.133 0 0 1 -9.124 9.127zm-37.353-43.592a7.131 7.131 0 0 0 -7.123 7.123v27.342a7.131 7.131 0 0 0 7.123 7.123h37.353a7.131 7.131 0 0 0 7.124-7.123v-27.342a7.131 7.131 0 0 0 -7.123-7.123z" fill="#2f3a5a"></path><path d="m69.3 90.8a5.3 5.3 0 1 0 -7.564 4.782v8.385h4.519v-8.386a5.293 5.293 0 0 0 3.045-4.781z" fill="#84879c"></path><path d="m66.259 104.966h-4.519a1 1 0 0 1 -1-1v-7.789a6.3 6.3 0 1 1 6.519 0v7.789a1 1 0 0 1 -1 1zm-3.519-2h2.519v-7.385a1 1 0 0 1 .572-.9 4.264 4.264 0 0 0 2.469-3.881 4.3 4.3 0 0 0 -8.609 0 4.264 4.264 0 0 0 2.473 3.878 1 1 0 0 1 .572.9z" fill="#2f3a5a"></path></svg>
                        <h5 class="card-title pt-4 pb-2">Private Q&A</h5>
                        <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                        <a href="free-demo.html" class="btn theme-btn bg-3">Try for free <i class="la la-arrow-right icon ms-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                        <a href="careers.html" class="btn theme-btn">Find a job <i class="la la-arrow-right icon ms-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box px-2 text-center">
                    <div class="icon-element mb-4 shadow-sm mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewbox="0 0 24 24" width="28px" fill="#48a868"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"></path></svg>
                    </div>
                    <div class="info-body">
            ...
            <div class="col-lg-5">
                <div class="info-box text-center">
                    ...
                    <div class="info-body">
                        ...
                        <a href="talent.html" class="btn theme-btn">Disilab Talent <i class="la la-arrow-right icon ms-1"></i></a>
                    </div>
                </div>
            </div><!-- end col-lg-5 -->
            <div class="col-lg-2">
            ...
            <div class="col-lg-5">
                <div class="info-box text-center">
                    ...
                    <div class="info-body">
                        ...
                        <p class="pb-4">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that</p>
                        <a href="advertising.html" class="btn theme-btn">Disilab Advertising <i class="la la-arrow-right icon ms-1"></i></a>
                    </div>
                </div>
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
