    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center align-items-center" id="msg_login">
                    <span class="badge bg-10 text-white fs-14">Correo Electronico o Contraseña Incorrecta</span>
                </div>

                <form method="post" id="mnt_login">
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Email</label>
                        <input class="form-control form--control" type="email" id="usu_email" name="usu_email" placeholder="Dirección de Email" required>
                    </div>
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Contraseña</label>
                        <div class="input-group mb-1">
                            <input class="form-control form--control password-field" type="password" id="usu_pass" name="usu_pass" placeholder="Ingrese Contraseña" required>
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        <div class="custom-control custom-checkbox fs-14">
                            ...
                            <label class="custom-control-label custom--control-label" for="rememberMe">Recuerdame!</label>
                        </div>
                        <a href="javascript:void(0)" class="lost-pass-btn fs-14 hover-underline">Olvidaste tu Contraseña?</a>
                    </div>
                    <div class="btn-box">
                        <button type="submit" class="btn theme-btn w-100">
                            Acceder a la Cuenta <i class="la la-arrow-right icon ms-1"></i>
                        </button>
                    </div>
                    <p class="create-account-text text-end fs-14 pt-1">
                        Registrate <a class="signup-btn text-color hover-underline" href="javascript:void(0)"> Crear Cuenta</a>
                    </p>
                    <br>
